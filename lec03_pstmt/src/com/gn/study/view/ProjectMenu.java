...
public class ProjectMenu {
	...
	private void editProjectOne() {
		System.out.println("*** 프로젝트 정보 수정 ***");
		List<ProjectVo> list = pc.selectProjectAll();
		printListProject(list);
		System.out.println("수정하고자 하는 프로젝트 번호와 새로운 프로젝트명을 입력하세요.");
		System.out.print("번호 : ");
		int projectNo = sc.nextInt();
		sc.nextLine();
		System.out.print("새 프로젝트명 : ");
	...
	private void searchByManager() {
		...
		List<ProjectVo> list = pc.selectProjectByManager(managerName);
